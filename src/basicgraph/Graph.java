...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		ArrayList<Integer> degreeSequenceList = new ArrayList<Integer>();
		for(int i=0;i<numVertices;i++){
			List<Integer> outDegree = getNeighbors(i);
			List<Integer> inDegree = getInNeighbors(i);
			degreeSequenceList.add(outDegree.size() + inDegree.size());
		}
	...
	public static void main (String[] args) {
		...
		*/
		...
		System.out.println(graphFromFile.adjacencyString());
		System.out.println(matrix.adjacencyString());
	}
}
